              ...
              <div className="flex justify-between items-start">
                <div className="flex flex-col">
                  <button
                    ...
                    <LocationOnIcon sx={{ fontSize: 14, color: "#FFFFFF" }} />
                    <div
                      className="text-[10px] font-medium leading-tight max-w-[160px] truncate text-gray-200"
                    >
                      {isFetchingLocation
                        ? "Detecting location..."
                        : currentLocation.name}
                ...
                {/* <motion.button
                  ...
                  onClick={() => setIsCustomOrderOpen(true)}
                  title="Custom Request"
                  className="flex items-center gap-1.5 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full px-3 py-1.5 text-white text-[11px] font-bold active:scale-95 transition-all shadow-sm"
                >
