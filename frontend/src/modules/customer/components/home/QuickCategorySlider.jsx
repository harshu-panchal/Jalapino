    ...
    <div className="w-full mb-0 mt-8 md:mt-12 overflow-hidden relative group z-20 font-['Inter'] bg-[#FAF8F6] pt-0 pb-5 md:pb-6">
      <div className="container mx-auto px-4 md:px-8 lg:px-[50px] relative">
        ...
        <div className="flex justify-between items-center mb-6 md:mb-8 px-1">
          <h2 className="text-lg md:text-[22px] font-black tracking-tight text-[var(--customer-header-base-color)] leading-none font-['Inter']">
            Shop by Categories
          </h2>
          <button
            onClick={() => navigate("/categories")}
            className="flex items-center gap-0.5 text-xs font-bold text-[var(--customer-header-base-color)] hover:opacity-80 transition-opacity cursor-pointer leading-none">
            View All
