...
export function formatSellerApplication(seller) {
  ...
  return {
    ...
    corporateContactEnabled: seller.corporateContactEnabled ?? true,
    noOfGuestsEnabled: seller.noOfGuestsEnabled ?? false,
    ...
    showStandardDateTime: seller.showStandardDateTime ?? false,
    showStandardDateTimeSlot: seller.showStandardDateTimeSlot ?? false,
    showAdvancedDateTime: seller.showAdvancedDateTime ?? false,
    showAdvancedDateTimeSlot: seller.showAdvancedDateTimeSlot ?? false,
    showMultipleDateTime: seller.showMultipleDateTime ?? false,
    isShopActive: seller.isShopActive ?? true,
    shopTimingsEnabled: seller.shopTimingsEnabled ?? false,
    shopOpeningTime: seller.shopOpeningTime || "10:30 AM",
    shopClosingTime: seller.shopClosingTime || "10:40 PM",
    advanceBookingBuffer: seller.advanceBookingBuffer || 0,
    advanceBookingBufferUnit: seller.advanceBookingBufferUnit || "days",
    demoTrialEnabled: seller.demoTrialEnabled ?? false,
    demoTrialDays: seller.demoTrialDays || 15,
    demoStartDate: seller.demoStartDate,
    ...
    quoteBudgetSelection: seller.quoteBudgetSelection || false,
    quoteCustomerNotes: seller.quoteCustomerNotes || false,
    ...
    acceptsCOD: seller.acceptsCOD !== undefined ? seller.acceptsCOD : true,
    acceptsRazorpay: seller.acceptsRazorpay !== undefined ? seller.acceptsRazorpay : true,
    ticketSystemEnabled: seller.ticketSystemEnabled !== undefined ? seller.ticketSystemEnabled : true,
    customerImageReviewEnabled: seller.customerImageReviewEnabled || false,
    videoUploadEnabled: seller.videoUploadEnabled || false,
    liveAddToCartEnabled: seller.liveAddToCartEnabled || false,
    liveServicesEnabled: seller.liveServicesEnabled || false,
