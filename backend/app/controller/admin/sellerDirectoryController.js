...
export const updateSellerDetails = async (req, res) => {
  try {
    ...
    if (req.body.functionLocationEnabled !== undefined) updateData.functionLocationEnabled = req.body.functionLocationEnabled;
    ...
    if (corporateContactEnabled !== undefined) updateData.corporateContactEnabled = corporateContactEnabled;
